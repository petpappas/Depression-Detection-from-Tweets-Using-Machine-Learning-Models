...
#When downloading all the necessary [nltk_data] it takes some time.It is not a problem with the code
...
plt.title("Depression(0) Character Count mean()  vs No Depression(1) Character Count mean()")
plt.show()
